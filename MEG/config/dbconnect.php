...
//
//
$host = '103.28.36.174:3306';
$user = 'usmart';
$password = 'usmart';
$database = 'nhlam1pn_dbsmart';
...
$conn = mysql_connect($host, $user, $password) or die('<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
mysql_select_db($database) or die('<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
