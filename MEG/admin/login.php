...
<html>
    <head>        
        ...
        <link rel="icon" type="image/ico" href="http://1contact.vn/meg/icon.ico"/>
...
//                mysql_query($log_query);
        ...
        <div class="loginBox">        
            <div class="loginHead">
                <img src="http://1contact.vn/meg/icon.ico" alt="One Contact" title="One Contact"/>
<!--                <img src="http://1contact.vn/meg/icon.ico" />-->
            </div>
